...
export default function HomePage({ seturl, setheaders }) {
  ...
  return (
    <>
      <Layout>
        <h1 className="text-3xl lg:text-4xl font-bold"><img width="75em" src="https://static.wixstatic.com/media/c938f4_b93a20ee562747a5bed7e1f64045434d~mv2.png"><br></br>Camera-Pan Video Downloader</h1>
